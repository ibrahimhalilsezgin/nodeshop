        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <!-- Company Info -->
                    ...
                    <img src="/nodeshop.png" alt="NodeShop" class="w-32 mb-4">
                    <p class="text-gray-400 mb-6 leading-relaxed">
                        Türkiye'nin en güvenilir Website satış platformu. 
                        2025'den beri mutlu müşterilere hizmet veriyoruz.
                    </p>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="#" class="text-gray-400 hover: transition-colors">Portifolio Websiteler</a></li>
                        <li><a href="#" class="text-gray-400 hover: transition-colors">Kurumsal Websiteler</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="/legal/privacypolicy" class="text-gray-400 hover: transition-colors">Gizlilik Politikası</a></li>
                        <li><a href="/legal/termsofuse" class="text-gray-400 hover: transition-colors">Kullanım Koşulları</a></li>
                        <li><a href="/legal/returnpolicy/" class="text-gray-400 hover: transition-colors">İade Politikası</a></li>
                        <li><a href="/legal/kvkk" class="text-gray-400 hover: transition-colors">KVKK</a></li>
                        <li><a href="/legal/cookies" class="text-gray-400 hover: transition-colors">Çerez Politikası</a></li>
                    </ul>
                </div>
            </div>
